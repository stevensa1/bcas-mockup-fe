    ...
    <>
      ...
      <section className="py-24 bg-white relative overflow-hidden">
          <div className="container mx-auto px-6 relative z-10">
              <div className="bg-bca-purple rounded-3xl p-8 md:p-16 text-center relative overflow-hidden shadow-2xl shadow-purple-200">
                  {/* Abstract Shapes */}
                  <div className="absolute top-0 left-0 w-64 h-64 bg-white/5 rounded-full -translate-x-1/2 -translate-y-1/2 blur-3xl"></div>
                  <div className="absolute bottom-0 right-0 w-64 h-64 bg-bca-gold/20 rounded-full translate-x-1/2 translate-y-1/2 blur-3xl"></div>
                  ...
                  >
                      ...
                      <div className="flex flex-col sm:flex-row justify-center gap-4">
                          <Link href="/digital" className="bg-bca-gold text-bca-purple px-8 py-4 rounded-xl font-bold text-lg hover:bg-white hover:text-bca-purple transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-1">
                              Download BSya
                          </Link>
